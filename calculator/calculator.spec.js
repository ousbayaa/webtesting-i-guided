...
describe('calculator.js', () => {
    ...
    describe('.add()', function() {
        ...
        it('should return 0 when called with no arguements', function (){
            expect(add()).toBe(0);
        });
        ...
        it('should sum a list of numbers separated by a comma', function (){
...
// try to make the tests fial, before making them pass
...
// more than likely to make it up and make it happen.